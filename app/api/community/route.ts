...
const globalRateLimit = globalThis as typeof globalThis & {
  ikizuliveCommunityRateLimit?: Map<string, RateLimitEntry>;
};

const rateLimit = globalRateLimit.ikizuliveCommunityRateLimit ?? new Map();
globalRateLimit.ikizuliveCommunityRateLimit = rateLimit;
